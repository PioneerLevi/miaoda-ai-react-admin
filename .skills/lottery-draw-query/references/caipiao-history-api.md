...
| Endpoint | `POST https://app-bv9t0unkehhd-api-qYGW2z745vzY-gateway.appmiaoda.com/caipiao/history` |
| Auth | `platform_managed`，`X-Gateway-Authorization: Bearer ${INTEGRATIONS_API_KEY}` |
| Content-Type | `application/json` |
| Third-party Domain | `app-bv9t0unkehhd-api-qYGW2z745vzY-gateway.appmiaoda.com` |
...
async function queryCaipiaoHistory(
  ...
  const url =
    `https://app-bv9t0unkehhd-api-qYGW2z745vzY-gateway.appmiaoda.com/caipiao/history?${params.toString()}`;
