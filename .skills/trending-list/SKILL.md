...
- **Endpoint**: `GET https://app-bv9t0unkehhd-api-qYGWoqjEmMnY-gateway.appmiaoda.com/v2/tools/trending_lists/medium`
...
async function queryTrendingList(type: number): Promise<TrendingItem[]> {
  const url = new URL(
    "https://app-bv9t0unkehhd-api-qYGWoqjEmMnY-gateway.appmiaoda.com/v2/tools/trending_lists/medium"
  );
