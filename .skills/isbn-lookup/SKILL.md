...
- **Endpoint**：`POST https://app-bv9t0unkehhd-api-ra5EZDjVKbza-gateway.appmiaoda.com/isbn/query`
...
async function queryIsbnInfo(isbn: string): Promise<IsbnDetail[]> {
  const url = new URL("https://app-bv9t0unkehhd-api-ra5EZDjVKbza-gateway.appmiaoda.com/isbn/query");
